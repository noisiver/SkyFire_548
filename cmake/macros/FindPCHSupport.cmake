...
FUNCTION(ADD_CXX_PCH_GCC TARGET_NAME PCH_HEADER PCH_SOURCE)
  ...
  ADD_CUSTOM_COMMAND(
    OUTPUT ${CMAKE_CURRENT_BINARY_DIR}/${PCH_HEADER_NAME}
    COMMAND ${CMAKE_COMMAND} -E copy_if_different
      ${CMAKE_CURRENT_SOURCE_DIR}/${PCH_HEADER}
      ${CMAKE_CURRENT_BINARY_DIR}/${PCH_HEADER_NAME}
    DEPENDS ${PCH_HEADER}
  )
  GENERATE_CXX_PCH_COMMAND(${TARGET_NAME} "${INCLUDE_FLAGS}" ${CMAKE_CURRENT_BINARY_DIR}/${PCH_HEADER_NAME} ${PCH_SOURCE} ${PCH_HEADER_OUT})
...
FUNCTION(ADD_CXX_PCH TARGET_NAME PCH_HEADER PCH_SOURCE)
    IF (COMMAND target_precompile_headers)
        GET_FILENAME_COMPONENT(PCH_HEADER_ABS "${PCH_HEADER}" ABSOLUTE
